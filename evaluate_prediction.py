...
if __name__ == '__main__':
    folder_ref = '/data1/keru/nnUNet/nnUNetFrame/DATASET/nnUNet_raw/Dataset900_BrainTumour/labelsTr'
    folder_pred = '/data1/keru/nnUNet/nnUNetFrame/DATASET/nnUNet_results/Dataset900_BrainTumour/nnUNetTrainer__nnUNetPlans__2d/fold_0/validation'
    output_file = '/data1/keru/nnUNet/nnUNetFrame/DATASET/nnUNet_results/Dataset900_BrainTumour/nnUNetTrainer__nnUNetPlans__2d/fold_0/validation/summary.json'
